...
a persistence unit "proyecto1-clientePersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "proyecto1-cliente/pom.xml":
...
artifact ("proyecto1-cliente.war") is already built. You can build
