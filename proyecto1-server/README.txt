...
a persistence unit "proyecto1-serverPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "proyecto1-server/pom.xml":
...
artifact ("proyecto1-server.war") is already built. You can build
